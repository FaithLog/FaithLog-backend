...
- #196 기도조·투표 목록 before 시나리오 준비:
  ...
  - PM 후속 review에서 seed/shape/direct k6까지 target default 제거, 1초/2초 상수 없는 runtime sampling 결속, exact app/DB 2-container 및 finite/nonnegative resource gate를 RED→GREEN 계약으로 보강했다. 이는 scenario 준비 검증이며 실제 측정 또는 성능 개선 수치가 아니다.
