...
Flyway migration, Supabase PostgreSQL, and Google Cloud Run deployment contracts are documented in [Cloud Run And Supabase Deployment](docs/deploy/cloud-run-supabase.md).
