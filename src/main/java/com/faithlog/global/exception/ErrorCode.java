...
public enum ErrorCode {
	...
	AUTH_EMAIL_VERIFICATION_REQUIRED(HttpStatus.BAD_REQUEST, "이메일 인증이 필요합니다."),
	AUTH_EMAIL_VERIFICATION_TOKEN_INVALID(HttpStatus.BAD_REQUEST, "이메일 인증이 유효하지 않습니다."),
	AUTH_EMAIL_VERIFICATION_CODE_INVALID(HttpStatus.BAD_REQUEST, "인증번호가 올바르지 않습니다."),
	AUTH_EMAIL_VERIFICATION_CODE_EXPIRED(HttpStatus.BAD_REQUEST, "인증번호가 만료되었습니다."),
	AUTH_EMAIL_VERIFICATION_ATTEMPTS_EXCEEDED(HttpStatus.TOO_MANY_REQUESTS, "인증번호 확인 횟수를 초과했습니다."),
	...
	USER_YEARLY_RECAP_INVALID_YEAR(HttpStatus.BAD_REQUEST, "조회할 수 없는 회고 연도입니다."),
	...
	ANNOUNCEMENT_CATEGORY_NOT_FOUND(HttpStatus.NOT_FOUND, "공지 카테고리를 찾을 수 없습니다."),
	ANNOUNCEMENT_CATEGORY_DUPLICATE(HttpStatus.CONFLICT, "이미 같은 이름의 공지 카테고리가 있습니다."),
	ANNOUNCEMENT_CATEGORY_INACTIVE(HttpStatus.BAD_REQUEST, "비활성 공지 카테고리는 사용할 수 없습니다."),
	ANNOUNCEMENT_MANAGE_FORBIDDEN(HttpStatus.FORBIDDEN, "공지 관리 권한이 없습니다."),
	ANNOUNCEMENT_ACCESS_FORBIDDEN(HttpStatus.FORBIDDEN, "공지 조회 권한이 없습니다."),
	ANNOUNCEMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "공지를 찾을 수 없습니다."),
	ANNOUNCEMENT_STATUS_CONFLICT(HttpStatus.CONFLICT, "현재 상태에서는 공지를 변경할 수 없습니다."),
	ANNOUNCEMENT_INVALID_PAGE(HttpStatus.BAD_REQUEST, "페이지 번호는 0 이상이어야 합니다."),
	ANNOUNCEMENT_INVALID_SIZE(HttpStatus.BAD_REQUEST, "페이지 크기는 1 이상 100 이하이어야 합니다."),
	...
	SHEPHERD_GROUP_DUPLICATE(HttpStatus.CONFLICT, "이미 같은 이름의 목장이 있습니다."),
	SHEPHERD_GROUP_NOT_FOUND(HttpStatus.NOT_FOUND, "목장을 찾을 수 없습니다."),
	SHEPHERD_GROUP_ACCESS_FORBIDDEN(HttpStatus.FORBIDDEN, "목장 조회 권한이 없습니다."),
	SHEPHERD_GROUP_MANAGE_FORBIDDEN(HttpStatus.FORBIDDEN, "목장 관리 권한이 없습니다."),
	SHEPHERD_GROUP_ASSIGNEE_REQUIRED(HttpStatus.CONFLICT, "목장 담당자는 1명 이상이어야 합니다."),
	SHEPHERD_GROUP_ASSIGNEE_INVALID(HttpStatus.BAD_REQUEST, "목장 담당자가 올바르지 않습니다."),
	SHEPHERD_INVALID_SERVICE_DATE(HttpStatus.BAD_REQUEST, "serviceDate는 일요일이어야 합니다."),
	SHEPHERD_INVALID_ATTENDANCE_COUNT(HttpStatus.BAD_REQUEST, "참여 인원은 0 이상이어야 합니다."),
	SHEPHERD_INVALID_ATTENDANCE_STATUS(HttpStatus.BAD_REQUEST, "목홀타 상태가 올바르지 않습니다."),
	SHEPHERD_ATTENDANCE_CONFLICT(HttpStatus.CONFLICT, "다른 사용자가 먼저 수정한 목홀타입니다. 새로고침 후 다시 저장해주세요."),
	SHEPHERD_INVALID_PAGE(HttpStatus.BAD_REQUEST, "페이지 번호는 0 이상이어야 합니다."),
	SHEPHERD_INVALID_SIZE(HttpStatus.BAD_REQUEST, "페이지 크기는 1 이상 100 이하이어야 합니다."),
