...
public enum ErrorCode {
	...
	DEVOTION_INVALID_SATURDAY_LATE_MINUTES(HttpStatus.BAD_REQUEST, "saturdayLateMinutes는 0 이상 1,440 이하이어야 합니다."),
	DEVOTION_FINE_AMOUNT_OUT_OF_RANGE(HttpStatus.BAD_REQUEST, "계산된 벌금 금액이 허용 범위를 초과했습니다."),
	...
	BILLING_PAYMENT_ACCOUNT_ACTIVATE_UNSUPPORTED(HttpStatus.BAD_REQUEST, "PENALTY 계좌만 활성화할 수 있습니다."),
	BILLING_PAYMENT_ACCOUNT_ACTIVE_DELETE_FORBIDDEN(HttpStatus.CONFLICT, "활성 계좌는 삭제할 수 없습니다."),
	...
	NOTIFICATION_COFFEE_CHARGE_REMINDER_FORBIDDEN(HttpStatus.FORBIDDEN, "활성 커피 담당자만 커피 미납 청구 알림을 보낼 수 있습니다."),
	NOTIFICATION_MEAL_CHARGE_REMINDER_FORBIDDEN(HttpStatus.FORBIDDEN, "활성 밥 담당자만 밥 미납 청구 알림을 보낼 수 있습니다."),
