...
EXPECTED_APP_IMAGE_ID=${EXPECTED_APP_IMAGE_ID:?EXPECTED_APP_IMAGE_ID requires approval}
...
EXPECTED_POSTGRES_IMAGE_ID=${EXPECTED_POSTGRES_IMAGE_ID:?EXPECTED_POSTGRES_IMAGE_ID requires approval}
REDIS_CONTAINER_ID=${REDIS_CONTAINER_ID:?REDIS_CONTAINER_ID is required}
EXPECTED_REDIS_COMPOSE_SERVICE=${EXPECTED_REDIS_COMPOSE_SERVICE:?EXPECTED_REDIS_COMPOSE_SERVICE requires approval}
EXPECTED_REDIS_IMAGE_ID=${EXPECTED_REDIS_IMAGE_ID:?EXPECTED_REDIS_IMAGE_ID requires approval}
...
EXPECTED_ACTIVE_MEMBERS=${EXPECTED_ACTIVE_MEMBERS:?EXPECTED_ACTIVE_MEMBERS requires approval}
EXPECTED_DUTY_ASSIGNMENTS=${EXPECTED_DUTY_ASSIGNMENTS:?EXPECTED_DUTY_ASSIGNMENTS requires approval}
RESOURCE_BOUNDARY_MAX_GAP_SECONDS=${RESOURCE_BOUNDARY_MAX_GAP_SECONDS:?RESOURCE_BOUNDARY_MAX_GAP_SECONDS requires approval}
