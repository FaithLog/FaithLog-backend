...
Installed-k6 verification is restricted to `k6 version`, `k6 inspect`, and the no-HTTP synthetic serialization fixture. Actual issue workloads remain blocked until the generated report says otherwise and PM performs the sequential measurement gate.
